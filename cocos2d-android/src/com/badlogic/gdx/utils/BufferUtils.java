...
public class BufferUtils {
        ...
        /** Copies the contents of src to dst, at dstPosition in the {@link Buffer}.  The {@link Buffer}'s position
         * and limit will remain unchanged.  <b>The Buffer must be a direct Buffer with native byte order.  No error
         * checking is performed</b>.
         * 
         * @param src the source array
         * @param dst the destination Buffer
         * @param dstPosition the position in the Buffer where src should be placed
         */
